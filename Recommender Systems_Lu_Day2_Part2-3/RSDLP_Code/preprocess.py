...
df = pd.read_csv('../../Dataset/MovieLens_20M/rating.csv')
...
print ('Transfiguring the original data ...')
...
print ('Writing the edited data ...')
df.to_csv('../../Dataset/MovieLens_20M/edited_rating.csv', index=False)