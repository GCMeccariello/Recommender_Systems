...
# load in the data
import os
if not os.path.exists('../../Dataset/MovieLens_20M/user2movie.json') or \
   not os.path.exists('../../Dataset/MovieLens_20M/movie2user.json') or \
   not os.path.exists('../../Dataset/MovieLens_20M/usermovie2rating.json') or \
   not os.path.exists('../../Dataset/MovieLens_20M/usermovie2rating_test.json'):
   import preprocess2dict


with open('../../Dataset/MovieLens_20M/user2movie.json', 'rb') as f:
  user2movie = pickle.load(f)

with open('../../Dataset/MovieLens_20M/movie2user.json', 'rb') as f:
  movie2user = pickle.load(f)

with open('../../Dataset/MovieLens_20M/usermovie2rating.json', 'rb') as f:
  usermovie2rating = pickle.load(f)

with open('../../Dataset/MovieLens_20M/usermovie2rating_test.json', 'rb') as f:
